const song = {
    ...
    getters: {
        ...
        listId: state => {
            ...
            if(!listId){
                listId = JSON.parse(window.sessionStorage.getItem('listId')||null); 
            }
            return listId;
        },
        isSent: state => {
            let isSent = state.isSent;
            if(!isSent){
                isSent = JSON.parse(window.sessionStorage.getItem('lisSent')||null); 
            }
            return isSent;
        },
    ...
    mutations: {
        ...
        setListId: (state,listId) => {
            state.listId = listId;
            window.sessionStorage.setItem('listId',JSON.stringify(listId));
        },
        setIsSent: (state,isSent) => {
            state.isSent = isSent;
            window.sessionStorage.setItem('isSent',JSON.stringify(isSent));
        },
    }
}
