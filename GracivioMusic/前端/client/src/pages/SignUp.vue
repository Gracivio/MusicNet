        ...
        <div class="signUp">
            ...
            <el-form :model="registerForm" ref="registerForm" label-width="70px" class="demo-ruleForm" :rules="rules">
                ...
                <el-form-item prop="username" label="昵称">
                    <el-input v-model="registerForm.username" placeholder="昵称"></el-input>
                </el-form-item>
                ...
                <div class="login-btn">
                    ...
                    <el-button type="primary" @click="SignUp" style="background-color: #c4ceb3; color: #fff;">确定</el-button>
                </div>
            </el-form>
        </div>
    </div>
