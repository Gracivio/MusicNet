    ...
    <div class="table">
        ...
        <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
            <el-form :model="registerForm" ref="registerForm" label-width="80px" action="" id="tf">
                <div>
                    <label>歌名</label>
                    <el-input v-model="registerForm.name" name="name" type="text"></el-input>
                </div>
                <div>
                    <label>专辑</label>
                    <el-input v-model="registerForm.introduction" name="introduction" type="text"></el-input>
                </div>
                <div class="set-lyric">
                    <label>歌词</label>
                    <el-input v-model="registerForm.lyric" name="lyric" type="textarea"></el-input>
                </div>
                <div>
                    <label>歌曲上传</label>
